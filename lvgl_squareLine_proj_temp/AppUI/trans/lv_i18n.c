...
static uint8_t zh_cn_hans_plural_fn(int32_t num)
{
...
static const lv_i18n_lang_t zh_cn_hans_lang = {
    .locale_name = "zh-CN-Hans",


    .locale_plural_fn = zh_cn_hans_plural_fn
};

static uint8_t zh_tw_hant_plural_fn(int32_t num)
{
...
static const lv_i18n_lang_t zh_tw_hant_lang = {
    .locale_name = "zh-TW-Hant",


    .locale_plural_fn = zh_tw_hant_plural_fn
};
