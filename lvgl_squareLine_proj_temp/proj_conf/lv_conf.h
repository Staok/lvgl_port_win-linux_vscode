...
#define LV_DRAW_COMPLEX 1
    ...
    *Caching has LV_SHADOW_CACHE_SIZE^2 RAM cost*/
    #define LV_SHADOW_CACHE_SIZE (1 * 1024)
 ...
 */
#define LV_LAYER_SIMPLE_BUF_SIZE          (4 * 1024 * 1024)
#define LV_LAYER_SIMPLE_FALLBACK_BUF_SIZE (4 * 1024 * 1024)
...
#define LV_DISP_ROT_MAX_BUF (2 * 1024 * 1024)
...
#define LV_USE_GPU_SDL 0
    ...
    #define LV_GPU_SDL_LRU_SIZE (8 * 1024 * 1024)
    /*Custom blend mode for mask drawing, disable if you need to link with older SDL2 lib*/
    #define LV_GPU_SDL_CUSTOM_BLEND_MODE (SDL_VERSION_ATLEAST(2, 28, 2))
#endif
