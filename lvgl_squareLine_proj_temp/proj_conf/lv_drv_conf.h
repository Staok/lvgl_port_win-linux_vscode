...
#  define SDL_DOUBLE_BUFFERED 0 // in lv_proj_hal_init() already use double buf，do not open here or disp will abnormal
...
#ifndef USE_MONITOR           // actually is call sdl fun, no need open this
...
/* in lv_proj_hal_init() already added the input device hal code
    no need use of here, here is set input read callback fun
*/
